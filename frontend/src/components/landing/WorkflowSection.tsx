...
const panels = [
  {
    step: "01 / Submit",
    title: "Intake",
    body: "Investigators submit through a guided portal. As documents arrive, the system reads the full protocol and predicts the review category — exempt, expedited, or full board — so administrators know what to expect before they open it.",
  ...
  },
  {
    step: "02 / Review",
    title: "Triage",
    body: "Every submission is checked against federal regulations for missing consent elements, incomplete risk disclosures, and similar gaps. Admins see what needs attention right away, triage with summaries, and draft revision letters in minutes instead of hours.",
  ...
  },
  {
    step: "03 / Decide",
    title: "Outcome",
    body: "Structured evaluations lead to clear decisions. Draft determination letters cite the specific regulatory criteria behind each outcome, and renewal reminders go out automatically — no more chasing over email.",
