...
export function TreeView({
  ...
  const renderNode = (
    ...
    return (
      <div key={node.id} className="select-none">
        <motion.div
          className={cn(
            "flex items-center py-2 px-3 cursor-pointer transition-all duration-200 relative group rounded-md mx-1 my-0.5",
            "hover:bg-muted/50",
        ...
        >
          ...
          {/* Label */}
          <span className="text-sm truncate flex-1 capitalize">
            {node.label}
          </span>
        </motion.div>
  ...
  return (
    <motion.div
      className={cn(
        "w-full bg-background rounded-xl",
        className,
      )}
