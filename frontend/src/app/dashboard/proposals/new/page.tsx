      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 flex-1 text-sm text-muted-foreground leading-relaxed">
            Upload PDFs or text (up to 100 MB per file for analysis). AI maps them to a protocol, runs
            consent and compliance, suggests revisions — then you confirm and submit like the AI draft
            path. No manual metadata wizard.
          </p>
